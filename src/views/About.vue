<template>
  <div class="about">
    ...
    <br>
    <p>With that in mind, we created an app for kids.  The app can be used to track rewards provided by parents and how the reward can be earned. It can also be used to track child's can set their own rewards and get them. 
    </h1>
    <h1 class="subheading grey--text">Examples</h1>
  </div>
</template>
